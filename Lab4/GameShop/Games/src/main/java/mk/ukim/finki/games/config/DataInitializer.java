...
public class DataInitializer {
    ...
    public void initData(){
        if(gamesRepository.findAll().isEmpty()){
            gamesRepository.saveAndFlush(Games.build("Cyberpunk 2077","RPG", Money.valueOf(Currency.MKD,5000), "CD Projekt Red", Stock.valueOf(10), new Date(), 0));
            ...
            gamesRepository.saveAndFlush(Games.build("GTA V","Action", Money.valueOf(Currency.MKD,4000), "Rockstar Games", Stock.valueOf(15), new Date(), 0));
            gamesRepository.saveAndFlush(Games.build("Red Dead Redemption 2","Action", Money.valueOf(Currency.MKD,4500), "Rockstar Games", Stock.valueOf(25), new Date(), 0));
            ...
            gamesRepository.saveAndFlush(Games.build("NBA 2K21","Sport", Money.valueOf(Currency.MKD,2500), "2K Sports", Stock.valueOf(35), new Date(), 0));
        }
